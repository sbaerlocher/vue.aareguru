            ...
            : h("div", [
                ...
                h("details", { style: "margin-top: 16px;" }, [
                  ...
                  h(
                    ...
                    {
                      style:
                        "background: #f5f5f5; padding: 12px; border-radius: 4px; font-size: 12px; overflow: auto;"
                    },
              ...
              ? h("div", [
                  ...
                  h("div", { style: "margin-top: 16px;" }, [
                    ...
                    h(
                      ...
                      {
                        style:
                          "display: flex; align-items: end; gap: 2px; height: 100px; background: #f5f5f5; padding: 8px; border-radius: 4px;"
                      },
